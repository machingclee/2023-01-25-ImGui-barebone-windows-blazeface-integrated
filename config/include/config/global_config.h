...
namespace global_config
{
    ...
    static std::string FACE_DETECTOR_ANCHOR_TENSOR_PATH = "C:\\Users\\user\\Repos\\C++\\2023-01-25-ImGui-barebone-windows-blazeface-integrated\\mediapipe_libtorch\\src\\mediapipe_libtorch\\face_detector_anchors.pt";
